...
if [ -f "/home/ubuntu/go/bin/moai" ]; then
	exec "/home/ubuntu/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/home/ubuntu/.local/bin/moai" ]; then
	exec "/home/ubuntu/.local/bin/moai" statusline < "$temp_file"
fi
